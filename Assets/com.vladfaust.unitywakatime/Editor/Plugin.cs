...
namespace WakaTime {
  ...
  public class Plugin {
    ...
    private static string _apiKey = "38d518d1-a3ab-430d-bf34-24798f8062ac";
    ...
    static void SendHeartbeat(bool fromSave = false) {
        try
        {
            ...
            var request =
                UnityWebRequest.Post(URL_PREFIX + "users/current/heartbeats?api_key=" + _apiKey, string.Empty);
